...
public static class DeleteCurrentMethod
{
    ...
    public static void EncapsulatePreviousInto(TreeNode previousNode, Placeholder targetPlaceholder)
    {
        ...
        {
            MethodHelpers.EncapsulateAllPartsOfNumberWithDigitsLeftOfIndex(previousNodeOldParentPlaceholder.Nodes.Count - 1, previousNodeOldParentPlaceholder.Nodes, targetPlaceholder);
        }
    }
}
